						...
						<div class="col-lg-3">
							<div class="brand_logo">
								<a class="brand_link" href="index.html">
									<img src="<?= PUBLIC_URL ?>ct_shop/images/logo/logo_01_1x.png" srcset="<?= PUBLIC_URL ?>ct_shop/images/logo/logo_01_2x.png 2x" alt="logo_not_found">
								</a>
								...
								<div class="row w-100 d-flex align-items-center justify-content-lg-between">
									...
									<div class="col-lg-3">
										<div class="login_cart_btn cart_btn">
											<div class="item_icon">
												<img src="<?= PUBLIC_URL ?>ct_shop/images/icons/shopping_cart.png" alt="user_icon">
											</div>
											<div class="item_content">
