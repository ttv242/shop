		...
		<main>
			...
			<div class="sidebar-menu-wrapper">
				...
				<div class="sidebar_mobile_menu">
					...
					<div class="msb_widget brand_logo text-center">
						<a href="index.html">
							<img src="<?= PUBLIC_URL ?>ct_shop/images/logo/logo_25_1x.png" srcset="<?= PUBLIC_URL ?>images/logo/logo_25_2x.png 2x" alt="logo_not_found">
						</a>
					</div>
			...
			================================================== -->
			<section class="breadcrumb_section text-white text-center text-uppercase d-flex align-items-end clearfix" data-background="<?= PUBLIC_URL ?>images/breadcrumb/bg_01.jpg">
				<div class="overlay" data-bg-color="#1d1d1d"></div>
				<div class="container">
					<h1 class="page_title text-white">Liên hệ</h1>
					...
					<div class="row justify-content-lg-between">
						...
						<div class="col-lg-5">
							<div class="main_contact_content">
								<h3 class="title_text mb_15">Liên lạc</h3>
								<p class="mb_50">
									Nếu bạn quan tâm đến việc làm việc với chúng tôi, vui lòng liên hệ.
								</p>
								<ul class="main_contact_info ul_li_block clearfix">
									<li>
										...
										<p class="mb-0">
											75 Đại lộ South Park, Melbourne, Úc
										</p>
									</li>
									<li>
										<span class="icon">
										...
										<p class="mb-0">8 800 567.890.11 - Văn phòng Trung ương</p>
									</li>
									<li>
										<span class="icon">
						...
						<div class="col-lg-7">
							<div class="main_contact_form">
								<h3 class="title_text mb_30">Nhận xét</h3>
								<form action="#">
									<div class="row">
									...
									<button type="submit" class="custom_btn bg_default_red text-uppercase">Gửi</button>
								</form>
							</div>
						</div>
